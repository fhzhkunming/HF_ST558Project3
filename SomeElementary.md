...
![](SomeElementary_files/figure-gfm/unnamed-chunk-8-1.png)<!-- -->
...
<img src="SomeElementary_files/figure-gfm/unnamed-chunk-17-1.png" style="display: block; margin: auto;" />
...
<img src="SomeElementary_files/figure-gfm/unnamed-chunk-18-1.png" style="display: block; margin: auto;" />
...
<img src="SomeElementary_files/figure-gfm/unnamed-chunk-19-1.png" style="display: block; margin: auto;" />
...
<img src="SomeElementary_files/figure-gfm/unnamed-chunk-20-1.png" style="display: block; margin: auto;" />
...
<img src="SomeElementary_files/figure-gfm/unnamed-chunk-21-1.png" style="display: block; margin: auto;" />
...
```
    ...
    ## No pre-processing
    ## Resampling: Cross-Validated (5 fold, repeated 3 times) 
    ## Summary of sample sizes: 2361, 2361, 2362, 2362, 2362, 2362, ... 
    ## Resampling results:
    ## 
    ##   logLoss  
    ##   0.5199349
...
![](SomeElementary_files/figure-gfm/unnamed-chunk-25-1.png)<!-- -->
...
![](SomeElementary_files/figure-gfm/unnamed-chunk-26-1.png)<!-- -->
...
![](SomeElementary_files/figure-gfm/unnamed-chunk-27-1.png)<!-- -->
...
```
    ...
    ##    0.01  0.001    0.5493652
    ##    0.01  0.010    0.5493730
    ##    0.01  0.100    0.5492236
    ##    0.10  0.001    0.5192559
    ##    0.10  0.010    0.5192787
    ##    0.10  0.100    0.5195497
    ##    1.00  0.001    0.5198103
    ##    1.00  0.010    0.5198014
    ##    1.00  0.100    0.5197704
    ##   10.00  0.001    0.5199578
    ##   10.00  0.010    0.5199067
    ##   10.00  0.100    0.5197327
    ## 
...
![](SomeElementary_files/figure-gfm/unnamed-chunk-28-1.png)<!-- -->
...
```
    ...
    ##       Model  LogLoss
    ## 1 log_loss1 1.562619
    ## 2 log_loss2 1.551100
    ## 3 log_loss3 1.497116
    ## 4 log_loss4 6.157634
    ## 5 log_loss5 0.969551
    ## 6 log_loss6 1.511070
